...
syn keyword djangoStatement contained and as by block endblock cycle debug else elif
syn keyword djangoStatement contained extends filter endfilter firstof for
syn keyword djangoStatement contained endfor if endif ifchanged endifchanged
syn keyword djangoStatement contained ifequal endifequal ifnotequal set
syn keyword djangoStatement contained endifnotequal in load not now or
...
" Django template block/macro tags
syn keyword djangoBlocks contained block endblock macro endmacro

" Django template preproc tags
syn keyword djangoLoader contained import include extends
...
"syn region djangoSepBlock start="{%" end="%}" contains=djangoBlocks display
"syn region djangoLoaderBlock start="{%" end="%}" contains=djangoLoader display
...
if version >= 508 || !exists("did_django_syn_inits")
  ...
  "HiLink djangoSepBlock htmlBoldItalic
  "HiLink djangoLoaderBlock ToDo
